...
+ เมื่อเข้าแอปธนาคาร
> + สิ่งที่คุณเจอ: คุณเปิดแอปแล้ววางโทรศัพท์ทิ้งไว้สักพัก พอกลับมาจะโอนเงิน ระบบจะ "ดีดออก" (Session Timeout) และบังคับให้คุณสแกนนิ้วหรือใส่รหัส PIN ใหม่อีกครั้ง
...
> + สิ่งที่คุณเจอ: ปกติคุณใช้อีเมลคณะที่หอพักก็เข้าได้เลย แต่วันหนึ่งไปนั่งร้านกาแฟต่างจังหวัด พอกดล็อกอิน ระบบกลับถามหา "รหัส OTP" หรือแจ้งเตือนว่า "มีการเข้าใช้งานจากอุปกรณ์ที่ไม่รู้จัก"
...
> + สิ่งที่คุณเจอ: เมื่อคุณต่อ Wi-Fi ห้างหรือมหาลัย คุณต้องล็อกอินผ่านหน้าเว็บ (Captive Portal) ทุกครั้ง แม้จะเคยต่อมาแล้วเมื่อวาน
